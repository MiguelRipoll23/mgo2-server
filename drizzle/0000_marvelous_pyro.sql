...
ALTER TABLE "users" ADD CONSTRAINT "users_main_character_id_characters_id_fk" FOREIGN KEY ("main_character_id") REFERENCES "public"."characters"("id") ON DELETE no action ON UPDATE no action;