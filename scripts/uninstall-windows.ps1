...
.DESCRIPTION
    ...
    project, and the configuration that came with it (appsettings.json, and
    the whole downloaded deployment directory when the deployment was installed
    with a piped script).
    ...
    and appsettings.json in it, is removed entirely; the source tree of a clone
    is never touched.
