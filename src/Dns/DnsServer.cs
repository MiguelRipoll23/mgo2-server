...
public sealed class DnsServer(DnsServerOptions options, ILogger<DnsServer> logger)
{
        ...
        CancellationToken cancellationToken)
    {
        try
        {
            ...
            {
                // Local domains always resolve to the advertised private address
                // so clients reach the published ports of this machine.
                var resolvedAddress = query.QueryType is DnsMessageCodec.IPv6RecordType
