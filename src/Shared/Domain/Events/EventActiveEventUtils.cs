...
/// <summary>
/// Codec of the active-event records: the start record the client restores its
/// live-event state from, the detail and its row updates, and the streamed list
/// the event screens open with.
/// <para>
